...
class EchoClient(BanyanBase):
    ...
    def __init__(self,num=10):
        ...
        super(EchoClient, self).__init__(process_name='EchoClient',loop_time=1)
        ...
        self.message_number = self.number_of_messages=num

        # send the first message - make sure that the server is already started
        self.publish_payload({'message_number': self.message_number,'clientID':self.clientID}, 'echo')
